...
#else
using LinkedListOfQueueItem = System.Collections.Generic.LinkedList<(FBEVJKGADQD.Kcp.KcpBuffer Data, byte Fragment)>;
using LinkedListNodeOfQueueItem = System.Collections.Generic.LinkedListNode<(FBEVJKGADQD.Kcp.KcpBuffer Data, byte Fragment)>;
#endif
